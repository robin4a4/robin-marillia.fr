...
export default function AnimationComponent() {
    ...
    onMount(() => {
        ...
        modelLoader(scene, './dist/assets/renders/macbook.glb', MODEL_NAMES.MACBOOK, {x: 0, y: 1.5, z: 0});
        modelLoader(scene, './dist/assets/renders/mug.glb', MODEL_NAMES.MUG, {x: 3, y: 2, z: 1});
        modelLoader(scene, './dist/assets/renders/pencil.glb', MODEL_NAMES.PENCIL, {x: -3, y: -1, z: -1});
        modelLoader(scene, './dist/assets/renders/rubber.glb', MODEL_NAMES.RUBBER, {x: 2, y: 0, z: 1});
        modelLoader(scene, './dist/assets/renders/rubix_cube.glb', MODEL_NAMES.RUBIX_CUBE, {x: -8, y: 3, z: -7});
